...
* 这个main activity必须在manifest使用包括 MAIN action and LAUNCHER category 的[`<intent-filter>`](http://developer.android.com/guide/topics/manifest/intent-filter-element.html)标签来声明。例如：
